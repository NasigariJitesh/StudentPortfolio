...
class OntheOffice extends Component {
  render() {
    ...
    return (
      ...
      >
        ...
        <path
          ...
          fill={theme.jacketColor}
        />
        <circle cx="331.55" cy="263.33" r="1.95" fill={theme.dark} />
        <path
        ...
        <circle cx="335.45" cy="324.89" r="1.95" fill={theme.dark} />
        <path
        ...
        <rect
          ...
          fill={theme.dark}
        />
        <circle cx="329.56" cy="279.43" r="4.26" fill={theme.imageHighlight} />
        <path
        ...
        <circle cx="329.6" cy="231.76" r="1.95" fill={theme.dark} />
        <circle cx="342.07" cy="354.9" r="1.95" opacity="0.1" />
        <circle cx="342.07" cy="354.12" r="1.95" fill={theme.dark} />
        <circle cx="335.45" cy="387.24" r="1.95" opacity="0.1" />
        <circle cx="335.45" cy="386.46" r="1.95" fill={theme.dark} />
        <path
